							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-bordered table-striped table-condensed mb-none">
										...
										<?php
											$varid = $_SESSION["ID"];
											$sql = "SELECT * FROM grupos WHERE id_criador = '$varid' OR id_criador = 0 ORDER BY id ASC;";
															...
															<label for="nome">Escolha o Grupo: </label>
																<select class="form-control input-lg" name="id_del">
																	...
																	<?php
																		...
																		$sql = "SELECT * FROM grupos WHERE id_criador = '$idcriador' ORDER BY nome_grupo ASC";
																		$res = mysqlexecuta($con,$sql);
																		while($row = mysqli_fetch_assoc($res)){
